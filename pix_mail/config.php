<?php
    ...
    /* Mailchimp setting */
    define('MC_APIKEY', 'mailchimp-api-key-here'); // Your API key from here - http://admin.mailchimp.com/account/api
    define('MC_LISTID', 'mailchimp-unique-id'); // List unique id from here - http://admin.mailchimp.com/lists/
